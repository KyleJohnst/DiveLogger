...
class DiveLogContainer extends Component {
  ...
  handleNewDive(newDive) {
    ...
    let countryIndex = this.findObjectByLinks(
  ...
  render() {
    return (
      <div className="DiveLogContainer">
        <div className="PageHeader">My Dive Log</div>
        <Router>
          <div>
            <NavBar />
          </div>
            ...
            <Switch>
                ...
                render={() => {
                  return (
                    <Home
                      ...
                      countries={this.state.locations}
                    />
                  );
                }}
              />
              ...
              <Route
                ...
                render={() => {
                  return (
                    <CountryDetail
                      location={this.state.locationView}
              ...
              <Route
                ...
                render={() => {
                  return (
                    <EditDive
                      dive={this.state.diveEdit}
                      locations={this.state.locations}
                      handleNewDive={this.handleNewDive}
                      editedDive={this.addEditedDive}
